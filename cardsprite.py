...
class CardSprite(pygame.sprite.Sprite):
    def __init__(self, name, suit, card_collection):
        ...
        self.target_position = (random.randint(0, globals.PLAY_WIDTH), random.randint(0, globals.HEIGHT)) # None
    ...
    def build_images(self):
        ...
        self.width = globals.CARD_WIDTH  # 96
        self.height = globals.CARD_HEIGHT  # 135
        self.suit_image = load_image("spr_" + self.suit + ".png")
        self.face_image = load_image("spr_card.png")
        self.back_image = load_image("spr_card_back.png")
    ...
    def update_images(self):
        ...
        self.face.blit(self.font.render(self.name, True, globals.BLACK), (globals.padding, globals.padding))
